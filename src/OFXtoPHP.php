...
class OFXtoPHP
{
    ...
    function getBank()
    {
        if(isset($this->ofx['SIGNONMSGSRSV1']['SONRS']['FI'])) {
            $return['name'] = $this->ofx['SIGNONMSGSRSV1']['SONRS']['FI']['ORG'];
        }

        $return['id'] = $this->ofx['BANKMSGSRSV1']['STMTTRNRS']['STMTRS']['BANKACCTFROM']['BANKID'];
